...
**nf-pcgr** is a bioinformatics analysis pipeline for the functional annotation and translation of somatic SNVs/InDels and copy number abberation for precision cancer medicine, using [Personal Cancer Genome Reporter (PCGR)](https://github.com/sigven/pcgr). In addition, nf-pcgr offers germline SNVs/INDELS intepretstion and annotation using [Cancer Predisposition Sequencing Reporter (CPSR)](https://github.com/sigven/cpsr/).
